                ...
                <div class="navbar-header">
                    <a href="home" class="navbar-brand">
                        ...
                        <div class="brand-title">
                            <span class="brand-text" style="color:white">Digitalent</span>
                        </div>
                    </a>
                </div>
                <!--================================-->
                                    ...
                                    <div class="nano-content">
                                        <ul class="head-list">
                                            ...
                                            <li>
                                                <a class="media" href="#">
                                                    <div class="media-left">
                                                        <img class="img-circle img-sm" alt="Profile Picture" src="{{ asset('assets/img/profile-photos/9.png') }}">
                                                    </div>
                                                    <div class="media-body">
                                            ...
                                            <li>
                                                <a class="media" href="#">
                                                    <div class="media-left">
                                                        <img class="img-circle img-sm" alt="Profile Picture" src="{{ asset('assets/img/profile-photos/3.png') }}">
                                                    </div>
                                                    <div class="media-body">
                                ...
                                <ul class="head-list">
                                    ...
                                    <li>
                                        ...
                                        onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();"><i class="demo-pli-unlock icon-lg icon-fw">
